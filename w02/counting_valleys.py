# An avid hiker keeps meticulous records of their hikes. During the last hike that took exactly 'step' steps,
...
def countingValleys(steps, path):
    ...
    for step in path:
        ...
        if sums > 0 and level[-1] != "H":
            level.append("H")

        if sums < 0 and level[-1] != "V":
            level.append("V")

    return level.count("V")
